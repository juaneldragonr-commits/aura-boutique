...
export default function SuccessPage() {
  return (
    <main className="min-h-[70vh] flex flex-col items-center justify-center p-8 text-center bg-white">
      ...
      <h1 className="text-5xl font-black text-slate-900 mb-4 tracking-tight">¡Pedido Confirmado!</h1>
      <p className="text-slate-500 text-xl max-w-lg mb-12">
        Gracias por elegir Aura Boutique. Hemos recibido tu pedido y estamos preparando tus prendas con el mayor cuidado.
      </p>
      <Link 
        href="/" 
